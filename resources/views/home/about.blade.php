            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="frontend/assets/images/team/member-1.jpg" alt="member photo">
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="frontend/assets/images/team/member-2.jpg" alt="member photo">
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img src="frontend/assets/images/team/member-3.jpg" alt="member photo">
